...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand("adlCutlang.start", () => {
        CatCodingPanel.createOrShow(context.extensionUri);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("adlCutlang.doRefactor", () => {
...
CatCodingPanel.viewType = "adlCutlang";
function getNonce() {
    let text = "";
